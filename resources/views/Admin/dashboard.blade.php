                ...
                <div class="welcome-section p-4 shadow-sm rounded-lg">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 d-none d-md-block">
                            <img src="{{ asset('assets/images/dashboard/welcome-illustration.svg') }}" class="w-50 img-fluid"
                                alt="Welcome">
                        </div>
                        <div class="col-md-8">
                    ...
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <input type="text" id="searchInput" class="form-control form-control-sm"
                                placeholder="Search Company..." style="width: 300px;" onkeyup="filterAccordion()">
                            <button id="toggleSectionButton" class="btn btn-light btn-sm" onclick="toggleSection()">
                                Expand
                            </button>
                        </div>
                    </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading{{ $company->id }}">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            aria-expanded="false" aria-controls="collapse{{ $company->id }}">
            ...
            <script>
                ...
                function filterAccordion() {
                    ...
                    accordionItems.forEach(item => {
                        const companyName = item.querySelector('.accordion-button').textContent.toLowerCase();
                        const isMatch = companyName.includes(searchInput);
