...
<head>
    ...
    <link rel="icon" href="{{ asset('Jobads.png') }}" type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('Jobads.png') }}" type="image/x-icon">
                        ...
                        <div class="job-card bg-white border border-gray-200 rounded p-4 min-w-0 w-full cursor-pointer hover:shadow-md transition-shadow duration-200"
                            ...
                            <div class="flex justify-between items-end mt-2"
                                ...
                                <p class="text-gray-500"
                                    style="font-size: 12px; color:#888888; margin-top: 3px; margin-bottom: 0px; line-height: 1.2;">
                                    {{ $job->job_id }}</p>
                            </div>
                        </div>
                    @endforeach
