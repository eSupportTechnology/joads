...
class CVController extends Controller
{
    public function index()
    {
        ...
        $academicEducations = $user->jobAcademicEducations; // Assuming relationship is defined

        return view('User.cv', compact('user', 'experiences', 'educations', 'academicEducations'));
    }
    ...
    public function index3()
    {
        ...
        return view('User.cv3', compact('user', 'experiences', 'educations', 'academicEducations'));
    }
    ...
    public function downloadCV($template)
    {
        try {
            ...
            // Generate filename
            $fileName = $template . '' . $user->id . '' . time() . '.pdf';
